...
AddEventHandler('onResourceStop', function(resource)
  if resource == GetCurrentResourceName() then
    DestroyAllProps()
    Citizen.InvokeNative(0xAAA34F8A7CB32098,Citizen.InvokeNative(0x43A66C31C68491C0,(-1)))
...
function AddPropToPlayer(prop1, bone, off1, off2, off3, rot1, rot2, rot3)
  ...
  prop = Citizen.InvokeNative(0x509D5878EB39E842,(GetHashKey(prop1)), x, y, z+0.2,  true,  true, true)
...
function OnEmotePlay(EmoteName)
  ...
  if Config.DisarmPlayer then
    if IsPedArmed(Citizen.InvokeNative(0x43A66C31C68491C0, -1), 7) then
      SetCurrentPedWeapon(Citizen.InvokeNative(0x43A66C31C68491C0, -1), GetHashKey('WEAPON_UNARMED'), true)
    end
  end
  ...
  if ChosenDict == "MaleScenario" or "Scenario" then 
    ...
    if ChosenDict == "MaleScenario" then if InVehicle then return end
      if PlayerGender == "male" then
        ClearPedTasks(Citizen.InvokeNative(0x43A66C31C68491C0, -1))
        TaskStartScenarioInPlace(Citizen.InvokeNative(0x43A66C31C68491C0, -1), ChosenAnimation, 0, true)
    ...
    elseif ChosenDict == "ScenarioObject" then if InVehicle then return end
      ...
      ClearPedTasks(Citizen.InvokeNative(0x43A66C31C68491C0, -1))
      TaskStartScenarioAtPosition(Citizen.InvokeNative(0x43A66C31C68491C0, -1), ChosenAnimation, BehindPlayer['x'], BehindPlayer['y'], BehindPlayer['z'], GetEntityHeading(PlayerPedId()), 0, 1, false)
      DebugPrint("Playing scenario = ("..ChosenAnimation..")")
      IsInAnimation = true
      return
