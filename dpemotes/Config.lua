...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://imgur.com/MvFTrRn.png",
...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Animacje',
        ['danceemotes'] = "🕺 Tańce",
        ['propemotes'] = "📦 Z przedmiotami",
        ['favoriteemotes'] = "🌟 Ulubione",
        ['favoriteinfo'] = "Wybierz tutaj ulubione animacje.",
        ['rfavorite'] = "Resetuj ulubione",
        ...
        ['cancelemoteinfo'] = "~r~X~w~ Anuluje aktualną animację",
        ['walkingstyles'] = "Style Chodzenia",
        ['resetdef'] = "Przywróc domyślne",
        ['normalreset'] = "Normal (Reset)",
        ['moods'] = "Wyrazy Twarzy",
        ['infoupdate'] = "Informacje",
        ['infoupdateav'] = "Informacje (Update dostępny)",
        ['infoupdateavtext'] = "~y~Update dostępny na githubie!",
        ...
        ['nocancel'] = "Nie robisz żadnej animacji.",
        ['maleonly'] = "Ta animacja jest tylko dla mężczyzn, sorry!",
        ['emotemenucmd'] = "Wpisz /emotemenu aby otworzyć menu.",
        ['shareemotes'] = "👫 Wspólne Animacje",
        ['shareemotesinfo'] = "Zaproś najbliższą osobę do animacji",
        ['sharedanceemotes'] = "🕺 Wspólne Tańce",
        ['notvalidsharedemote'] = "is not a valid shared emote.",
        ['sentrequestto'] = "Zaproszono ~y~",
        ['nobodyclose'] = "~r~Nie ma nikgo w pobliżu.",
        ['doyouwanna'] = "~y~Y~w~ aby zaakceptować, ~r~L~w~ aby odrzucić (~g~",
        ['refuseemote'] = "~r~Propozycja odrzucona.",
        ['makenearby'] = "makes the nearby player play",
        ['camera'] = "Naciśnij ~y~G~w~ aby włączyć flash'a.",
        ['makeitrain'] = "Naciśnij ~y~G~w~ aby rzucać.",
        ['pee'] = "Trzymaj ~y~G~w~ aby sikać.",
        ['spraychamp'] = "Trzymaj ~y~G~w~ aby wystrzelić szampana",
        ['bound'] = "Bound ",
        ['to'] = "to",
        ['currentlyboundemotes'] = " Currently bound emotes:",
        ['notvalidkey'] = "zły przycisk.",
        ['keybinds'] = "🔢 Bindy",
        ['keybindsinfo'] = "Use"
  },
  ['fr'] = {
